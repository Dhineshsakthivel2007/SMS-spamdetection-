...
# installed.
TCL_PREFIX='D:/navybias/myvenev\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/navybias/myvenev\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/navybias/myvenev\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/navybias/myvenev\Library\include'
...
TCL_PACKAGE_PATH='D:/navybias/myvenev\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/navybias/myvenev\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/navybias/myvenev\Library\lib\tclstub86.lib'
